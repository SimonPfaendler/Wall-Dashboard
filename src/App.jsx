...
import { BringComponent } from './components/BringComponent';
  ...
  return (
    <div className="h-screen w-screen bg-black overflow-hidden flex items-center justify-center p-8">
      <div className="w-full h-full grid grid-cols-10 gap-8">
        <div className="col-span-2 rounded-[3rem] border border-gray-900 bg-gray-950/50 flex items-center justify-center relative overflow-hidden ring-1 ring-white/5 shadow-2xl">
          <div className="absolute inset-0 bg-gradient-to-br from-blue-900/5 to-purple-900/5 pointer-events-none" />
          <ClockComponent />
        </div>

        <div className="col-span-2 rounded-[3rem] overflow-hidden shadow-2xl ring-1 ring-white/5">
          <BringComponent />
        </div>
